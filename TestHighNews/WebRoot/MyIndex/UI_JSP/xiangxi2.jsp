...
<div id="page_header"> 
  ...
  <div class="navbar navbar-default navbar-fixed-top global-navbar" role="navigation">
    <div class="container" style="position:relative;"> 
      <!-- 导航头 -->
      <div class="navbar-header"> <a href="<%=request.getContextPath()%>/M1227/m1227_1.jsp" ><span style=" vertical-align:middle; font-size:30px; margin-left:8px; margin-top:20px;">欢迎来highNews！</span></a>
